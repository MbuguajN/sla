    ...
    <div className="space-y-6">
      <section className="grid grid-cols-1 gap-4 xl:grid-cols-12">
        <div className="xl:col-span-5 rounded-3xl bg-white dark:bg-black/40 border border-gray-100 dark:border-white/10 p-7">
          ...
          <h1 className="text-3xl md:text-4xl font-black text-slate-800 dark:text-white tracking-tight">Suggestions Box</h1>
        ...
        <div className="xl:col-span-7 grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="rounded-3xl bg-white dark:bg-black/40 border border-gray-100 dark:border-white/10 p-6">
            ...
            <p className="text-3xl md:text-4xl font-black text-slate-800 dark:text-white mt-2">{suggestions.filter((s) => s.status === "OPEN").length}</p>
          </div>
          <div className="rounded-3xl bg-white dark:bg-black/40 border border-gray-100 dark:border-white/10 p-6">
            <p className="text-xs font-black uppercase tracking-[0.16em] text-gray-400">In Review</p>
            <p className="text-3xl md:text-4xl font-black text-slate-800 dark:text-white mt-2">{suggestions.filter((s) => s.status === "IN_REVIEW").length}</p>
          </div>
          <div className="rounded-3xl bg-white dark:bg-black/40 border border-gray-100 dark:border-white/10 p-6">
            <p className="text-xs font-black uppercase tracking-[0.16em] text-gray-400">Actioned</p>
            <p className="text-3xl md:text-4xl font-black text-slate-800 dark:text-white mt-2">{suggestions.filter((s) => s.status === "ACTIONED").length}</p>
          </div>
        </div>
      </section>
