        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in">
          <div className="bg-base-100 border border-base-200 rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
            <div className="p-6 border-b border-base-200 bg-base-200/20">
              <h3 className="text-sm font-bold uppercase tracking-wider">Deploy Resource to Project</h3>
              <p className="text-xs font-normal text-base-content/40 mt-1">Add user as watcher to all directives</p>
            </div>
