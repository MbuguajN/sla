  ...
  return (
    <>
      ...
      >
        ...
        <span className="text-xs font-bold uppercase tracking-widest flex-1 text-left">Internal Search...</span>
          ...
          <div className="relative w-full max-w-xl bg-base-100 rounded-2xl shadow-2xl border border-base-300 overflow-hidden animate-in fade-in zoom-in duration-200">
            ...
            <div className="p-4 bg-base-200/20">
              <div className="flex flex-col gap-2">
                <span className="text-[10px] font-black uppercase tracking-widest text-base-content/40 px-2">Quick Navigation</span>
                <div className="grid grid-cols-1 gap-1">
                   ...
                   >
                     ...
                     <div className="flex flex-col flex-1">
                        ...
                        <span className="text-[10px] text-base-content/40 uppercase font-black">View all active directives</span>
                     </div>
