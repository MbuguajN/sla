            ...
            <div className="flex items-center gap-1.5 overflow-x-auto pb-1 no-scrollbar">
                {days.map((day) => {
                    ...
                    return (
                        ...
                        >
                            <div className={cn(
                                "text-[10px] font-medium uppercase mb-0.5",
                                isCurrentDay ? "text-primary-content/70" : "text-base-content/40"
                            )}>
                                {format(day, 'EEE')}
                            </div>
                            <div className={cn(
                            ...
                            {hasTasks && (
                                <div className={cn(
                                    "mt-1.5 text-[10px] font-medium rounded-full px-1.5 py-0.5 min-w-[18px] text-center",
                            ...
                            {hasTasks && (
                                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-48 opacity-0 group-hover:opacity-100 pointer-events-none z-50 transition-opacity">
                                    <div className="bg-neutral text-neutral-content p-3 rounded-lg shadow-lg text-xs">
                                        <div className="font-medium mb-1.5 text-neutral-content/60 text-[10px]">
                                        ...
                                        <div className="flex flex-col gap-1">
                                            ...
                                            {count > 3 && (
                                                <div className="text-[10px] text-neutral-content/40">
                                                    +{count - 3} more
                                                </div>
                                            )}
                                        </div>
