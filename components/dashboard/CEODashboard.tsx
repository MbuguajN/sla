        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-base-300 pb-8">
                ...
                <div className="flex items-center gap-3">
                    <div className="relative group">
                        <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-base-content/70 group-focus-within:text-primary transition-colors" />
                        <input
                            type="text"
                    ...
                    <div className="flex items-center bg-base-200 border border-base-300 p-1 rounded-xl">
                        <button
                            ...
                            className={cn("p-2 rounded-lg transition-all", viewMode === 'grid' ? "bg-base-100 shadow-sm text-primary" : "text-base-content/70 hover:text-base-content")}
                        >
                            <LayoutGrid className="w-4 h-4" />
                        </button>
                        <button
                            onClick={() => setViewMode('list')}
                            className={cn("p-2 rounded-lg transition-all", viewMode === 'list' ? "bg-base-100 shadow-sm text-primary" : "text-base-content/70 hover:text-base-content")}
                        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {[
                    ...
                    { label: 'Critical Breaches', value: overdueCount, sub: 'Requires Attention', icon: AlertCircle, color: overdueCount > 0 ? 'text-error' : 'text-base-content/70' },
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
                ...
                <div className="xl:col-span-12 space-y-6">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            ...
                            <h2 className="text-sm font-bold uppercase tracking-wider text-base-content/80">Active Projects</h2>
                        </div>
                    ...
                    {viewMode === 'grid' ? (
                            ...
                            {filteredProjects.map(project => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <p className="text-sm text-base-content/70 font-bold uppercase tracking-tight mb-4">
                        ...
                        <div className="bg-base-100 border border-base-content/10 rounded-2xl overflow-hidden shadow-md">
                            <table className="table w-full">
                                <thead className="bg-base-200/50 text-xs font-bold uppercase tracking-wider text-base-content/70 border-b border-base-300">
                                    <tr>
                                    ...
                                    {filteredProjects.map(project => {
                                        ...
                                        return (
                                            <tr key={project.id} className="hover:bg-base-200/20 group transition-all h-16">
                                                ...
                                                <td>
                                                    <span className="text-xs font-bold text-base-content/80 uppercase tracking-wider">{total} Active</span>
                                                </td>
                ...
                <div className="xl:col-span-12 space-y-6">
                    <div className="flex items-center gap-2">
                        <div className="w-1.5 h-4 bg-primary rounded-full" />
                        <h2 className="text-sm font-bold uppercase tracking-wider text-base-content/80">Operational Registry</h2>
                    </div>
                                    ...
                                    {filteredTasks.slice(0, 12).map(task => {
                                        ...
                                        return (
                                            <tr key={task.id} className="hover:bg-base-200/20 group transition-all h-20">
                                                ...
                                                <td>
                                                    {task.project ? (
                                                        <Link href={`/projects/${task.project.id}`} className="text-xs font-bold text-base-content/70 hover:text-primary transition-colors">
                                                            {task.project.title}
                                                        </Link>
                                                    ) : (
                                                ...
                                                <td>
                                                    {task.assignee?.name ? (
                                                        <div className="flex items-center gap-2">
                                                            <div className="w-6 h-6 rounded-lg bg-base-200 text-base-content/80 font-bold text-xs flex items-center justify-center">
                                                                {task.assignee.name.charAt(0)}
                                                            </div>
                                                            <span className="text-xs font-bold text-base-content/80">{task.assignee.name.split(' ')[0]}</span>
                                                        </div>
                                                    ) : (
