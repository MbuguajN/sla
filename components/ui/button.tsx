...
const buttonVariants = cva(
  [
    "inline-flex shrink-0 items-center justify-center gap-2 rounded-lg font-semibold text-sm whitespace-nowrap",
    ...
    variants: {
      variant: {
        ...
        warning: [
          ...
          "hover:bg-warning/90 hover:shadow-md hover:shadow-warning/25",
          "hover:-translate-y-0.5",
        ].join(" "),
      },
      size: {
